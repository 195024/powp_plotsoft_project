...
public class SelectShapeWindow extends JFrame implements WindowComponent {
	 ...
	 * i pola do podania wsp�rz�dnych X i Y punktu startowego rysowania figury.
	 * Na �rodku jest JPanel z CardLayout, gdzie ka�dy card to osobny layout dla figury
	 * tworzony w metodach "private JPanel createSHAPENAMECard()".
	 * Na dole BorderLayout istnieje przycisk OK, kt�rego listener wybiera odpowiedni� metod�
	 * "private void parseSHAPENAMEData()" s�u��c� przetworzeniu danych wej�ciowych.
	 */
	public SelectShapeWindow() {
		...
		// Combo box
		String comboBoxItems[] = { "Rectangle" };
	...
	/**
	 * Przetwarza dane wej�ciowe przekazuj�c je do obiektu Singleton dla kszta�tu Rectangle
	 * i tworzy obiekt DrawShapeCommand dla tego kszta�tu.
	 * @param crossCard Panel z inputami dla kszta�tu Rectangle.
	 * @param startingPoint Punkt startowy rysowania figury.
